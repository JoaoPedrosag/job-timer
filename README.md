Job timer é um app com integração com firebase para gerenciamento de freelas, com tasks e quantidade horas trabalhadas.
Utilizado Packages: flutter_modular, bloc, isar.
🛠️ Packages Utilizadas
Firebase
Core
Auth | Sign-in
